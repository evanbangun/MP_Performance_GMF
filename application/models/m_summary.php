...
class m_summary extends CI_Model
{
	public function tampilassignment($ac_type, $date_min, $date_max)
	{
		$query = $this->db->query("	SELECT CASE WHEN gmfu.recommendation = 1 THEN 'Remain'
                                            ...
                                            md.ms_num, md.ac_type, md.task_code, me.ac_eff, mr.ref_man, gmfu.id_gmf as id_gmf, gmfu.name_gmf as name_gmf, garudau.id_garuda as id_garuda, garudau.name_garuda as name_garuda, 
									...
									Left Join (SELECT ee.ms_num as ms_num, ee.ac_type as ac_type, ee.id_user as id_gmf, ee.recommendation as recommendation, u.name as name_gmf, ee.rec_threshold as rec_threshold, ee.rec_interval as rec_interval, ee.create_date as create_date
